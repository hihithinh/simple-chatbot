...
from app.api.api_v1.endpoints import intents, responses, nlu_examples, rasa, data_sources, qa_generator, rasa_integration
...
api_router.include_router(rasa_integration.router, prefix="/rasa-training", tags=["rasa-training"])
